...
import halftoneVertexShader from '../shaders/lesson-37-halftone/vertex.glsl'
import halftoneFragmentShader from '../shaders/lesson-37-halftone/fragment.glsl'
...
gui.add(material.uniforms.uShadowRepetition, 'value')
    .min(1)
    .max(300)
    .step(1)
    .name('uShadowRepetition')
...
gui.add(material.uniforms.uLightRepetition, 'value')
    .min(1)
    .max(300)
    .step(1)
    .name('uLightRepetition')
